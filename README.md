...
## 🚀 Features
- **Random Word Selection:** Picks a challenge from a predefined list.
- **ASCII Art Visuals:** Displays the hangman status using graphics.
- **Smart Validation:** Prevents losing lives on duplicate guesses.
- **Clean UI:** Clears the terminal screen after each guess.
